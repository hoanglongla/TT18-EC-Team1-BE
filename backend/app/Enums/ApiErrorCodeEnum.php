...
final class ApiErrorCodeEnum extends Enum
{
    ...
    const PRODUCT_UPDATE_FAIL =16005;


    const SERVICE_NOT_EXIST = 160001;
    const SERVICE_FAIL_VALIDATION = 160002;
    const SERVICE_ADD_FAIL = 160003;
    const SERVICE_DELETE_FAIL = 160004;
    const SERVICE_UPDATE_FAIL =16005;
